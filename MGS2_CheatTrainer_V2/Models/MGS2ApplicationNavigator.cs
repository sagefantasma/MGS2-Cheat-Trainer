...
namespace MGS2_CheatTrainer_V2.Models
{
    ...
    internal struct Mgs2Pointer
    {
        ...
        internal static List<int> Ray1NestedPointers = new List<int> { 0x016EA0F8, 0x170 }; //all fixed 2.0.2 -- fixed 2.1.0
    ...
    internal struct Mgs2AoB
    {
        ...
        internal static byte[] OriginalReloadBytes = { 0xFF, 0xC8, 0x89, 0x05, 0x8E, 0x89, 0x19, 0x01 };
        internal static string RestoreReload = "90 90 89 05 8E 89 19 01";
        internal static string NeverReload = "FF C8 89 05 8E 89 19 01";
        ...
        internal static byte[] OriginalBleedDamageBytes = { 0x66, 0x89, 0x8B, 0xD2, 0x08, 0x00, 0x00, 0xB9, 0x00, 0x00, 0x01, 0x00, 0xE8, 0xCC, 0xA0, 0x03 };
        internal static string RestoreBleedDamage = "90 90 90 90 90 90 90 B9 00 00 01 00 E8 CC A0 03";
        internal static string NoBleedDamage = "66 89 8B D2 08 00 00 B9 00 00 01 00 E8 CC A0 03";
        internal static byte[] OriginalBurnDamageBytes = { 0x66, 0x89, 0x83, 0xD2, 0x08, 0x00, 0x00, 0x8B, 0x0D, 0x32, 0x88, 0x1A, 0x01, 0x0F, 0xBF, 0xD0 };
        internal static string RestoreBurnDamage = "90 90 90 90 90 90 90 8B 0D 32 88 1A 01 0F BF D0";
        internal static string NoBurnDamage = "66 89 83 D2 08 00 00 8B 0D 32 88 1A 01 0F BF D0";
        ...
        internal static string ItemMenuPause = "09 2D 1D CA 5E 01";
        internal static byte[] OriginalItemMenuPauseBytes = { 0x09, 0x2D, 0x1D, 0xCA, 0x5E, 0x01 };
        internal static string WeaponMenuPause = "09 2D 1F AF 5E 01";
        internal static byte[] OriginalWeaponMenuPauseBytes = { 0x09, 0x2D, 0x1F, 0xAF, 0x5E, 0x01 };
        ...
        internal static string RemovePlantFilter = "F6 05 BF CD 4C 01 01";
        internal static byte[] OriginalRemovePlantFilterBytes = { 0xF6, 0x05, 0xBF, 0xCD, 0x4C, 0x01, 0x01 };
        ...
        internal static string RemoveTankerFilter = "E5 F8 FF 66 41 0F 6E 8F 2C 03";
        internal static byte[] OriginalRemoveTankerFilterBytes = { 0xE5, 0xF8, 0xFF, 0x66, 0x41, 0x0F, 0x6E, 0x8F, 0x2C, 0x03 };
        ...
        //public static string InvisibleToCyphersAoB = "48 85 88 E8 13 00 00 0F 85 50 04";
        public static string InvisibleToCyphersAoB = "48 85 88 E8 13 00 00 0F 85 4C 04";
        //public static byte[] OriginalInvisibleToCyphersBytes = { 0x48, 0x85, 0x88, 0xE8, 0x13, 0x00, 0x00, 0x0F, 0x85, 0x50, 0x04 };
        public static byte[] OriginalInvisibleToCyphersBytes = { 0x48, 0x85, 0x88, 0xE8, 0x13, 0x00, 0x00, 0x0F, 0x85, 0x4C, 0x04 };
        public static string InvisibleToCamerasAoB = "83 4B 4C 01 E8 93 F7 1C";
        public static byte[] OriginalInvisibleToCamerasBytes = { 0x83, 0x4B, 0x4C, 0x01, 0xE8, 0x93, 0xF7, 0x1C };
    ...
    internal struct Mgs2Offset
    {
        ...
        public static readonly MemoryOffset CurrentCharacter = new MemoryOffset(0x1C, 0x22);
        ...
        public static readonly MemoryOffset DamageTaken = new MemoryOffset(24);
        public static readonly MemoryOffset KillCount = new MemoryOffset(22);
        public static readonly MemoryOffset AlertCount = new MemoryOffset(20);
        public static readonly MemoryOffset ShotCount = new MemoryOffset(18);
        public static readonly MemoryOffset PlayTime = new MemoryOffset(10, 13);
        public static readonly MemoryOffset SaveCount = new MemoryOffset(8);
        public static readonly MemoryOffset ContinueCount = new MemoryOffset(4);
        public static readonly MemoryOffset MechsDestroyed = new MemoryOffset(42);
        ...
        public static readonly MemoryOffset Zoom = new MemoryOffset(-191); //Should be at +15525C9
